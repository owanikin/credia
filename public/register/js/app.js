...
function formSubmit(e) {
  ...
  let staffsize = document.querySelector('#staffsize').value
  let howmuch = document.querySelector('#howmuch').value
  ...
  //await sendMessage(name, email, phone, companyname, typeofregistration, natureofbusiness, yearsinoperation, corporate, transacting, howlong, kindoffinance, usedfor);
  ...
  swal("Successfully completed your business assessment!", "", "success").then(()=>{
...
async function sendMessage(name, email, phone, companyname, typeofregistration, natureofbusiness, yearsinoperation, corporate, transacting, howlong, howmuch, staffsize, kindoffinance, usedfor) {
